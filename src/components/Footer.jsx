      ...
      <div className='sm:max-w-[1140px] sm:mx-auto text-gray-800 mb-14  pt-6 px-[2em]'>
        ...
        <div className='sm:w-[80%] mx-auto grid sm:grid-cols-3 grid-cols-2 gap-10 py-10'>
            <div className='flex flex-col justify-center items-start gap-4 capitalize px-6'>
                <a href="/home">
                  <p className='hover:text-black text-gray-600 dark:text-gray-300 w-fit'>Home</p>
                </a>
                <a href="/about">
                  <p className='hover:text-black text-gray-600  dark:text-gray-300 w-fit'>About</p>
                </a>
                <a href="/skills">
                  <p className='hover:text-black text-gray-600  dark:text-gray-300 w-fit'>Skills</p>
                </a>
                <a href="/qualification">
                  <p className='hover:text-black text-gray-600  dark:text-gray-300 w-fit'>Qualification</p>
                </a>
                <a href="/project">
                  <p className='hover:text-black text-gray-600  dark:text-gray-300 w-fit'>Projects</p>
                </a>
                <a href="/contact">
                  <p className='hover:text-black text-gray-600  dark:text-gray-300 w-fit'>Contact</p>
                </a>
            </div>
