        ...
        <div id='contact'
            ...
            <div className='sm:max-w-[55%] mx-auto  rounded-md py-7 text-center'>
                <div className='max-w-full flex sm:flex-row flex-col justify-center items-center gap-5'>
                    <div className='sm:max-w-[46%] w-full flex flex-col text-gray-500 hover:text-gray-900'>
                ...
                <div className='w-full text-start py-6 sm:px-4 flex flex-col text-gray-500 hover:text-gray-900'>
                ...
                <div className='w-full text-start py-6 sm:px-4 flex flex-col gap-y-9 text-gray-500 hover:text-gray-900'>
